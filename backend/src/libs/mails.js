...
const emailVerificationMailGenContent = (name, verificationUrl) => {
  return {
    body: {
      name: name,
      intro: "Welcome to Our LeetBlast plateform! We're very excited to have you on board.",
      action: {
        instructions: "To get started with our platform, please click here:",
        button: {
...
const forgotPasswordVerificationMailGenContent = (name, passwordResetUrl) => {
  return {
    body: {
      name: name,
      intro: "Welcome to LeetBlast plateform! We're very excited to have you on board. ",
      action: {
